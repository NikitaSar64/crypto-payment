...
const gamblingTexts = {
  ...
  "gambling-btn": {
    ru: ["Счета", "Обмен", "Готовые решения"],
    en: ["Invoices", "Exchange", "Turnkey Solutions"],
  },
  "gambling-slide-1": {
    ru: [
      "Счета",
      "Счета – способ выставления счетов, при котором криптовалюта привязана к определенной сумме фиата, которую клиент должен заплатить в течение короткого периода времени (15 минут), после чего счет должен быть перегенерирован с новый обменный курс.",
      "Гибкий инструмент, позволяющий вашим клиентам расплачиваться криптовалютой. и зачисляет на ваш счет необходимую сумму в евро или другая валюта.",
    ],
    en: [
      "Invoices",
  ...
  "media-slide-1": {
    ru: ["Почему будущее за системами криптопроцессинга", "11 Декабря, 2019"],
    en: ["Why Crypto Processing Systems Is The Future", "December 11, 2019"],
  },
  "media-slide-2": {
    ru: ["Почему будущее за системами криптопроцессинга", "11 Декабря, 2019"],
    en: ["Why Crypto Processing Systems Is The Future", "December 11, 2019"],
  ...
  "reviews-title": {
    ru: ["Отзывы о нас"],
    en: ["Customers About Us"],
  },
  "reviews-text": {
    ru: [
      "Мы ценим каждое мнение о нашем сервисе и благодарим каждого из васза ваше доверие к CryptoTransfer.com",
    ],
    en: [
      "We appreciate every opinion on our service and thank each one of you for your trust in CryptoTransfer.com",
    ],
  },
  "reviews-slide-1": {
    ru: [
      "Имя клиента",
      "NOWPayments чрезвычайно легко интегрируется в существующие веб-сайты, и вы даже можете использовать наши ссылки для пожертвований, чтобы отобразить на ваших аккаунтах в социальных сетях. Для интернет-магазинов мы предлагаем настраиваемые виджеты, кнопки и плагины для всех основных платформа электронной коммерции существует! Прием криптоплатежей никогда не было проще, и самое лучшее, что только между принятием биткойнов в качестве оплаты проходит несколько минут в вашем интернет-магазине.",
    ],
    en: [
      "Name of client",
      "NOWPayments is extremely easy to integrate into existing websites, and you can even use our donation links to display on your social media accounts. For online stores, we offer custom widgets, buttons, and plugins for every major e-commerce platform in existence! Accepting crypto payments has never been easier, and the best thing is that only several minutes stand between accepting Bitcoin as payment at your online store.",
    ],
  },
  "reviews-slide-2": {
    ru: [
...
function changePageLang() {
  for (const key in gamblingTexts) {
    const elements = document.querySelectorAll(`[data-lang=${key}]`);

    if (elements) {
      elements.forEach((elem, index) => {
        elem.textContent = gamblingTexts[key][currentLang][index];
      });
    }
  }
